...
if __name__ == "__main__":
    ...
    energy_r2 = get_r2(energy_true_list, energy_pred_list)
    forces_direct_r2 = get_r2(forces_true_list, forces_pred_direct_list)
    forces_grad_r2 = get_r2(forces_true_list, forces_pred_grad_list)
    print(f"Energy R2: ", energy_r2)
    print(f"Forces Direct R2: ", forces_direct_r2)
    print(f"Forces Grad R2: ", forces_grad_r2)
    ...
    fig, ax = plt.subplots()
    plt.scatter(
        forces_pred_direct_list, forces_true_list, s=8, c=hist2d_norm, vmin=0, vmax=1
    )
    plt.clim(0, 1)
    ax.plot(ax.get_xlim(), ax.get_xlim(), ls="--", color="red")
    plt.colorbar()
    ...
    plt.draw()
    plt.tight_layout()
    plt.savefig(f"./Forces_Scatterplot_direct" + ".png", dpi=400)

    hist2d_norm = getcolordensity(forces_pred_grad_list, forces_true_list)
    fig, ax = plt.subplots()
    plt.scatter(
        forces_pred_grad_list, forces_true_list, s=8, c=hist2d_norm, vmin=0, vmax=1
    )
    plt.clim(0, 1)
    ax.plot(ax.get_xlim(), ax.get_xlim(), ls="--", color="red")
    plt.colorbar()
    ...
    plt.draw()
    plt.tight_layout()
    plt.savefig(f"./Forces_Scatterplot_grad" + ".png", dpi=400)
