...
# It's important to do this after scaling the data
...
def md17_pre_transform(data):
    ...
    # # NOTE  I was getting a R2 score of 0.6 with invariant prediction, which indicates that the data wasn't representatice
...
if __name__ == "__main__":
    ...
    filename = os.path.join(os.path.dirname(__file__), "md17_DimeNet.json")
    ...
    if not (
        ...
        train, val, test = create_y(train, val, test)
